...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_sample_and_hold_xx_0 = blocks.sample_and_hold_ii()
        self.blocks_int_to_float_0 = blocks.int_to_float(1, 1)
        self.analog_random_uniform_source_x_0 = analog.random_uniform_source_i(1, 8, 0)
        self.analog_const_source_x_0 = analog.sig_source_b(0, analog.GR_CONST_WAVE, 0, 0, button)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.blocks_sample_and_hold_xx_0, 1))
        self.connect((self.analog_random_uniform_source_x_0, 0), (self.blocks_sample_and_hold_xx_0, 0))
        self.connect((self.blocks_int_to_float_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_sample_and_hold_xx_0, 0), (self.blocks_int_to_float_0, 0))
    ...
    def set_button(self, button):
        self.button = button
        self.analog_const_source_x_0.set_offset(self.button)
